...
window.addEventListener('load', () => {
    ...
    class Game {
        ...
        ensureNoMobileControls() {
            ...
            // First remove the overlay container
            ...
            // Remove individual controls by ID - be thorough
            const controlIds = ['left-btn', 'right-btn', 'shoot-btn', 'mobile-controls'];
            controlIds.forEach(id => {
                // There might be multiple elements with the same ID due to duplication issues
            ...
            // Additionally, clean up any stray control buttons that might not have proper IDs
            // This helps with duplicated controls that might have lost their IDs
        ...
        addOnScreenControls() {
            ...
            if (!this.detectMobile()) {
                ...
                // Still clean up any stray controls
                this.ensureNoMobileControls();
                return;
            }
            
            // IMPORTANT: Clean up ALL existing mobile controls first to avoid duplicates
            this.ensureNoMobileControls();
...
function createStableControlOverlay() {
  // Use strict mobile detection - ONLY show controls on actual mobile devices or in iframe
  // Check if we have a game instance to use its detection method
